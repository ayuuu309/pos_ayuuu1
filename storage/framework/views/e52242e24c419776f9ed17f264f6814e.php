...
<div class="container py-4">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 pb-3 border-bottom">
        ...
        <div class="mt-3 mt-md-0">
            <a href="<?php echo e(route('admin.users.create')); ?>" class="btn btn-primary fw-semibold px-4 shadow-sm">
                    ...
                    <tr>
                        ...
                        <td class="py-3 px-4 text-center">
                            <?php if($user->role->name == 'admin'): ?>
                                <span class="badge bg-purple-subtle text-purple border border-purple-subtle rounded-pill px-3 py-2 text-capitalize" style="background-color: #f3e8ff; color: #7e22ce;">
                                    <i class="fa-solid fa-user-shield me-1"></i> <?php echo e($user->role->name); ?>

                                </span>
                            <?php else: ?>
                                <span class="badge bg-success-subtle text-success border border-success-subtle rounded-pill px-3 py-2 text-capitalize">
                                    <i class="fa-solid fa-user me-1"></i> <?php echo e($user->role->name); ?>
                        ...
                        <td class="py-3 px-4 text-center">
                            <div class="d-flex align-items-center justify-content-center gap-2">
                                <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="btn btn-sm btn-outline-warning fw-semibold px-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_ayuuu1\resources\views/users/index.blade.php ENDPATH**/ ?>